...
default[:hadoop][:namenode    ][:run_state]  = :start
default[:hadoop][:secondarynn ][:run_state]  = :start
default[:hadoop][:jobtracker  ][:run_state]  = :start
#
...
default[:hadoop][:jobtracker ][:system_hdfsdir]  = '/home/ubuntu/hadoop/mapred/system' # note: on the HDFS
default[:hadoop][:jobtracker ][:staging_hdfsdir] = '/home/ubuntu/hadoop/mapred/system' # note: on the HDFS
default[:hadoop][:datanode   ][:data_dirs]       = '/home/ubuntu/hadoop/hdfs/data'
default[:hadoop][:tasktracker][:scratch_dirs]    = '/home/ubuntu/hadoop/mapred/system'

default[:hadoop][:home_dir] = "/home/ubuntu/hadoop"
default[:hadoop][:conf_dir] = "/home/ubuntu/hadoop/conf"
default[:hadoop][:pid_dir]  = "/var/run/hadoop"
default[:hadoop][:log_dir]  = "/home/ubuntu/hadoop/logs"          # nil set in recipe using volume_dirs
default[:hadoop][:tmp_dir]  = "/home/ubuntu/hadoop/tmp"          # nil set in recipe using volume_dirs
default[:hadoop][:maper_dir] = "/home/ubuntu/hadoop/mapred"
...
default[:java][:java_home] = '/usr/lib/jvm/java-6-openjdk/jre'
